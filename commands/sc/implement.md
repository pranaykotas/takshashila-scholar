...
> **Context Framework Note**: This behavioral instruction activates when OpenCode users type `/sc:implement` patterns. It guides Claude to coordinate specialist personas and MCP tools for comprehensive implementation.
...
```
**Usage**: Type this in your OpenCode conversation to activate implementation behavioral mode with coordinated expertise and systematic development approach.
