...
> **分支说明**：`main` 分支对应 Claude Code 工作流。如果你使用 Codex CLI，请查看 [`codex` 分支](https://github.com/Galaxy-Dawn/claude-scholar/tree/codex)；如果你使用 OpenCode，请查看 [`opencode` 分支](https://github.com/Galaxy-Dawn/claude-scholar/tree/opencode)。
